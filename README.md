...
- 🆕 **自动检查更新**：启动时静默检查 GitHub Releases，有新版会弹窗提醒
...
- 之后每 6 小时复查一次
- 发现新版本时会弹出对话框，提供四个选项：
  - **立即下载**：直接打开 zip 资产下载链接
  - **查看详情**：跳转 Release 页面看更新说明
  - **跳过此版本**：本次升级不再提醒（更高版本仍会提醒）
  - **稍后再说**：关闭弹窗，下次启动再提醒
- 你也可以从菜单栏 📋 → **检查更新...** 手动触发

> 因为应用未做 Apple 开发者签名，所以选择"提示 + 跳转下载"而非全自动覆盖。下载新版后按安装步骤覆盖即可。
